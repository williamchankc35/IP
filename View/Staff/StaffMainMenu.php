    ...
    <body>
        <div class="topBanner">
            ...
            <div class="rightBannerContent" >
                ...
                <a href="../Login/StaffLogin.php"><button class="btnLogout">Logout</button></a>
            </div>
        </div>
        ...
        <div>
            <div class="sidebar">
                <div class="navigation">
                    <ul>
                        <li class="no-sub"> <a href="Product.php" target="iframe">Product</a>
                        <li class="no-sub"> <a href="Catalog.php" target="iframe">Catalog</a>
                       
                        <li class="no-sub"> <a href="Report.php" target="iframe">Report</a>       
                    </ul>
                </div>
            </div>
